...
HD_PWD='C:/College/Thesis/VivadoProjects/my_bram/my_bram.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log my_bram.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source my_bram.tcl -notrace
