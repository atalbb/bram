...
HD_PWD='C:/College/Thesis/VivadoProjects/my_bram/my_bram.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log my_bram.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source my_bram.tcl
